...
public class MockUserTable extends MockDatabase {
    ...
    private ServerAcknowledge addUser(String username, ArrayList<Object> values) {
    ...
    public ServerAcknowledge createUser(String sessionToken, String username, String hashedPassword, boolean createBillboard,
        ...
        if ( validateMockToken(sessionToken) ) {
            ...
            values.add(editUser);
            ServerAcknowledge dbResponse = addUser(username, values); // Update the table
